/*
 ============================================================================
 Name        :  calculateTaxes.c
 Author      :  Suleman Dawood
 Version     :  1.0
 Copyright   : 
 Date        :  04/14/2018
 Description :  
 This program the taxe due or the refund for a family based on the following
 imaginary formula then prints the amount of tax or the refund in C.
...
/* ====================== getData =========================
    Reads tax data from the keyboard.
    Pre     Nothing
...
//  Statements
    ...
    printf("Enter total payroll deductions: ");
    scanf("%lf", taxPaid);
...
/* ====================== calcTaxes =========================
    ...
    Pre     Given-income, numOfDependents, & taxPaid
    Post    Tax income, total tax, and tax due calc'd
*/
...
//  Statements
    *taxableInc = totInc -
                    (numOfDependents* DEDN_PER_DPNDNT);
    *totTax =
...
/* ====================== printInformation =========================
    Prints a table showing all information.
...
/* ====================== bracketTax =========================
    ...
    Post    Return the tax for a particular bracket.
*/
double bracketTax (double income,
                   double startLimit,
                   double stopLimit,
